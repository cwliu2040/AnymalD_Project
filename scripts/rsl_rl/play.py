...
from anymal_locomotion.artifacts import EXPORT_ROOT, LOG_ROOT
from anymal_locomotion.policy_contract import write_export_metadata
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    write_export_metadata(export_model_dir, resume_path)
